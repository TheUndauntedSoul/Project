...
// PLACEHOLDERS AND NAME FORMATTING LOGIC (3)    
    ...
    try {
        ...
        // 6. DEDUCTIONS
        double sss = PayrollCalculator.getSSSEmployeeShare(salaryInput);
        double ph = PayrollCalculator.getPhilHealthShare(salaryInput);
        double pi = PayrollCalculator.getPagIBIGShare();
        double tax = PayrollCalculator.calculateTax(grossPay - (sss + ph + pi));
        double netPay = grossPay - (sss + ph + pi + tax + loans);
